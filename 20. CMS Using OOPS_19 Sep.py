...
"""
1. Determine the variables in the program that are required
2. Among these variables, determine which variables are required for data transfer between BLL 
and PL. These variables are to be created as instance variables
3. Create different methods in the class according to the requirements
"""
# BLL Starts Here
class Customer:
